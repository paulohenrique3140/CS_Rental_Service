...
namespace CS_Rental_Service
{
        class Program
        {
                static void Main(string[] args)
                {
                        ...
                        string formattedDate = d1.ToString("dd/MM/yyyy hh:mm:ss tt");
                        Console.WriteLine(formattedDate);

                        string res = "s";
                        do {
                            Console.WriteLine();
                            Console.Write("Enter a date in format example (01/01/2000 15:00 or 15:30 etc): ");
                            DateTime d2 = DateTime.ParseExact(Console.ReadLine(), "dd/MM/yyyy hh:mm:ss tt", CultureInfo.InvariantCulture);
                            Console.WriteLine(d2.ToString("dd/MM/yyyy hh:mm tt"));
                                                                ...
                                                                switch (rentMenuOption)
                                                                {
                                                                        case 1:
                                                                                ...
                                                                                if (ciRent == 'c')
                                                                                {
                                                                                        ...
                                                                                        if (ans == 'y')
                                                                                        {
                                                                                                clientRegister.findById(idRent, typeRent).AddContract(companyRental, clientRegister, carRegister);
                                                                                ...
                                                                                else
                                                                                {
                                                                                        ...
                                                                                        if (ans == 'y')
                                                                                        {
                                                                                                clientRegister.findById(idRent, typeRent).AddContract(individualRental, clientRegister, carRegister);
                                                                                                Console.WriteLine("\nYour contract has been successfully confirmed!");
                ...
                public static string Sumary(Rental rental, Client_Register clientRegister, Car_Register carRegister)
                {
                        ...
                        Client sumaryClient = clientRegister.findById(rental.ClientId, rental.Type);
                        
                        StringBuilder sb = new StringBuilder();
                        sb.AppendLine("Client: " + sumaryClient);
